// src/components/VLKeyDropdown.js
// Voice Leader specific key dropdown without sharp/flat toggle

import React, { useState } from 'react';

const VLKeyDropdown = ({ selectedKey, onKeyChange }) => {
  const [isOpen, setIsOpen] = useState(false);

  // Define keys for VL - using only flats for consistency, excluding F# and D# minor
  const majorKeys = [
    { key: 'C', relative: 'Am' },
    { key: 'D♭', relative: 'B♭m' },
    { key: 'D', relative: 'Bm' },
  ...
  return (
    <div className="relative">
      {/* Key Dropdown Only - No Sharp/Flat Toggle */}
      <div className="relative">
        <button
